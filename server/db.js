...
function defaultSeedStore() {
  ...
  return {
    ...
    users: [
      ...
      { id: "cust-1", loginId: "hotel", name: "沐森旅店", email: "hotel@example.com", role: "customer", customerTierId: "tier-hotel", allowedPaymentMethods: ["monthly_billing", "bank_transfer"], isActive: true, taxId: "24567890", companyName: "沐森旅店股份有限公司", contactName: "王小姐", shippingAddress: "台北市信義區松仁路 100 號", shippingDetail: "1 樓收貨區，週一至週五 10:00-17:00 可收貨", passwordHash: customerHash },
      { id: "cust-2", loginId: "salon", name: "青禾沙龍", email: "salon@example.com", role: "customer", customerTierId: "tier-a", allowedPaymentMethods: ["bank_transfer", "credit_card"], isActive: true, taxId: "87654321", companyName: "青禾沙龍有限公司", contactName: "林先生", shippingAddress: "台中市西屯區市政北二路 88 號", shippingDetail: "請送至 3 樓櫃台", passwordHash: customerHash },
    ],
    products: [
      { id: "p1", sku: "SH-001-300", name: "柔順洗髮精 300ml", brand: "ML Lab", series: "基礎洗沐", category: "洗沐", description: "適合飯店備品與日常零售的溫和洗髮精。", image: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?auto=format&fit=crop&w=900&q=80", salesUnit: "瓶", packSize: "24 瓶/箱", moq: 24, orderIncrement: 24, isOrderable: true, isActive: true },
      { id: "p2", sku: "SH-001-4000", name: "柔順洗髮精 4000ml", brand: "ML Lab", series: "基礎洗沐", category: "洗沐", description: "大容量補充桶，適合飯店與沙龍後場使用。", image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=900&q=80", salesUnit: "桶", packSize: "4 桶/箱", moq: 4, orderIncrement: 4, isOrderable: true, isActive: true },
      { id: "p3", sku: "OEM-FACE-001", name: "OEM 溫和潔面乳", brand: "Private Label", series: "OEM", category: "臉部保養", description: "可供品牌客戶進行配方與包裝客製。", image: "https://images.unsplash.com/photo-1596755389378-c31d21fd1273?auto=format&fit=crop&w=900&q=80", salesUnit: "瓶", packSize: "120 瓶/箱", moq: 120, orderIncrement: 120, isOrderable: false, isActive: true },
      { id: "p4", sku: "BD-002-500", name: "草本沐浴乳 500ml", brand: "Aroma Pro", series: "草本系列", category: "洗沐", description: "清爽草本香氣，適合通路與團購銷售。", image: "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?auto=format&fit=crop&w=900&q=80", salesUnit: "瓶", packSize: "12 瓶/箱", moq: 12, orderIncrement: 12, isOrderable: false, isActive: true },
    ],
    prices: [
